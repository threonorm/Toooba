...
//
// On Sun Mar 13 11:05:49 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkAluDispToRegFifo(CLK,
  ...
  wire [11 : 0] IF_m_m_specBits_0_dummy2_0_read__26_AND_m_m_sp_ETC___d129,
  ...
  assign first =
	     { m_m_row_0,
	       IF_m_m_specBits_0_dummy2_0_read__26_AND_m_m_sp_ETC___d129 } ;
  ...
  assign MUX_m_m_valid_0_dummy2_0$write_1__SEL_1 =
	     EN_specUpdate_incorrectSpeculation &&
	     (specUpdate_incorrectSpeculation_kill_all ||
	      IF_m_m_specBits_0_dummy2_0_read__26_AND_m_m_sp_ETC___d129[specUpdate_incorrectSpeculation_kill_tag]) ;

  // inlined wires
  assign m_m_valid_0_lat_0$whas =
	     MUX_m_m_valid_0_dummy2_0$write_1__SEL_1 || EN_deq ;
  assign m_m_specBits_0_lat_1$wget =
	     sb__h10511 & specUpdate_correctSpeculation_mask ;
  ...
  // remaining internal signals
  assign IF_m_m_specBits_0_dummy2_0_read__26_AND_m_m_sp_ETC___d129 =
	     (m_m_specBits_0_dummy2_0$Q_OUT &&
	      m_m_specBits_0_dummy2_1$Q_OUT) ?
	       m_m_specBits_0_rl :
	       12'd0 ;
