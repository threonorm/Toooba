...
//
// On Sun Mar 13 11:05:11 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkTourPred(CLK,
  ...
  wire [11 : 0] globalHist__h5324, globalHist__h5860;
  ...
  // inlined wires
  assign predCnt_lat_0$wget = n__read__h5349 + 2'd1 ;
  assign predCnt_lat_1$wget = n__read__h5885 + 2'd1 ;
  ...
  // submodule choiceBht
  assign choiceBht$ADDR_1 = globalHist__h5860 ;
  assign choiceBht$ADDR_2 = globalHist__h5324 ;
  ...
  // submodule globalBht
  assign globalBht$ADDR_1 = globalHist__h5860 ;
  assign globalBht$ADDR_2 = globalHist__h5324 ;
  ...
  assign IF_predCnt_lat_0_whas_THEN_predCnt_lat_0_wget__ETC___d8 =
	     EN_pred_0_pred ? upd__h5989 : predCnt_rl ;
  assign IF_predRes_lat_0_whas__5_THEN_predRes_lat_0_wg_ETC___d18 =
	     EN_pred_0_pred ? upd__h6441 : predRes_rl ;
  assign globalHist__h5324 = gHistReg$history >> n__read__h5349 ;
  assign globalHist__h5860 = gHistReg$history >> n__read__h5885 ;
  assign n__read__h5349 =
	     (predCnt_dummy2_0$Q_OUT && predCnt_dummy2_1$Q_OUT &&
	      predCnt_dummy2_2$Q_OUT) ?
	       predCnt_rl :
	       2'd0 ;
  assign n__read__h5885 =
  ...
  assign res__h6220 =
	     (predRes_dummy2_1$Q_OUT && predRes_dummy2_2$Q_OUT) ?
	       IF_predRes_lat_0_whas__5_THEN_predRes_lat_0_wg_ETC___d18 :
	       2'd0 ;
  assign upd__h4047 = predRes_lat_1$wget ;
  assign upd__h4297 = predCnt_lat_1$wget ;
  assign upd__h5989 = predCnt_lat_0$wget ;
  assign upd__h6441 = predRes_lat_0$wget ;
  assign x__h5564 = 2'd1 << n__read__h5349 ;
  assign x__h6269 = 2'd1 << n__read__h5885 ;
  assign y__h5773 = ~x__h5564 ;
  assign y__h6475 = ~x__h6269 ;
