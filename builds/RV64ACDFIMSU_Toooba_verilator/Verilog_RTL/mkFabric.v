...
//
// On Sun Mar 13 10:45:56 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkFabric(CLK,
  ...
  wire [1 : 0] IF_fabric_v_rg_r_beat_count_0_37_EQ_fabric_v_f_ETC___d466,
	       ...
	       x1_avValue_rresp__h17050,
	       x1_avValue_rresp__h17633,
	       x1_avValue_rresp__h18206;
  ...
  assign soc_map_m_uart0_addr_base__3_ULE_fabric_xactor_ETC___d72 =
	     ...
	     (!soc_map_m_boot_rom_addr_base__2_ULE_fabric_xac_ETC___d23 ||
	      !fabric_xactors_from_masters_0_f_wr_addr_first__ETC___d25) ;
  assign x1_avValue_rresp__h17050 =
	     (fabric_xactors_to_slaves_0_f_rd_data$D_OUT[2:1] == 2'b0 &&
	      !fabric_xactors_to_slaves_0_f_rd_data$D_OUT[0]) ?
	       2'b10 :
	       fabric_xactors_to_slaves_0_f_rd_data$D_OUT[2:1] ;
  assign x1_avValue_rresp__h17633 =
	     (fabric_xactors_to_slaves_1_f_rd_data$D_OUT[2:1] == 2'b0 &&
	      !fabric_xactors_to_slaves_1_f_rd_data$D_OUT[0]) ?
	       2'b10 :
	       fabric_xactors_to_slaves_1_f_rd_data$D_OUT[2:1] ;
  assign x1_avValue_rresp__h18206 =
	     (fabric_xactors_to_slaves_2_f_rd_data$D_OUT[2:1] == 2'b0 &&
	      !fabric_xactors_to_slaves_2_f_rd_data$D_OUT[0]) ?
	       2'b10 :
	       fabric_xactors_to_slaves_2_f_rd_data$D_OUT[2:1] ;
  assign x__h11349 = fabric_v_rg_wd_beat_count_0 + 8'd1 ;
  assign x__h11736 = fabric_v_rg_wd_beat_count_1 + 8'd1 ;
  assign x__h17072 = fabric_v_rg_r_beat_count_0 + 8'd1 ;
  assign x__h17655 = fabric_v_rg_r_beat_count_1 + 8'd1 ;
  assign x__h18228 = fabric_v_rg_r_beat_count_2 + 8'd1 ;
  assign x__h20338 = fabric_v_rg_r_err_beat_count_0 + 8'd1 ;
  assign x__h20687 = fabric_v_rg_r_err_beat_count_1 + 8'd1 ;
