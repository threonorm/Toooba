...
//
// On Sun Mar 13 10:47:00 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkMMIOInst(CLK,
  ...
  wire IF_reqQ_enqReq_lat_1_whas_THEN_reqQ_enqReq_lat_ETC___d13,
       IF_respQ_enqReq_lat_1_whas__7_THEN_respQ_enqRe_ETC___d96,
       NOT_pendQ_enqReq_dummy2_2_read__94_09_OR_IF_pe_ETC___d419,
       NOT_reqQ_clearReq_dummy2_1_read__3_4_OR_IF_req_ETC___d58,
       NOT_reqQ_enqReq_dummy2_2_read__9_4_OR_IF_reqQ__ETC___d79,
       NOT_respQ_clearReq_dummy2_1_read__12_13_OR_IF__ETC___d317,
       NOT_respQ_enqReq_dummy2_2_read__18_33_OR_IF_re_ETC___d338,
       pendQ_enqReq_dummy2_2_read__94_AND_IF_pendQ_en_ETC___d406,
       reqQ_enqReq_dummy2_2_read__9_AND_IF_reqQ_enqRe_ETC___d71,
       respQ_enqReq_dummy2_2_read__18_AND_IF_respQ_en_ETC___d330;
  ...
  assign respQ_data_0$D_IN =
	     { EN_toCore_instResp_enq ?
		 respQ_enqReq_lat_0$wget[67] :
		 respQ_enqReq_rl[67],
	       EN_toCore_instResp_enq ?
		 respQ_enqReq_lat_0$wget[66:51] :
		 respQ_enqReq_rl[66:51],
	       EN_toCore_instResp_enq ?
		 respQ_enqReq_lat_0$wget[50] :
		 respQ_enqReq_rl[50],
	       EN_toCore_instResp_enq ?
		 respQ_enqReq_lat_0$wget[49:34] :
		 respQ_enqReq_rl[49:34],
	       EN_toCore_instResp_enq ?
		 respQ_enqReq_lat_0$wget[33] :
		 respQ_enqReq_rl[33],
	       EN_toCore_instResp_enq ?
		 respQ_enqReq_lat_0$wget[32:17] :
		 respQ_enqReq_rl[32:17],
	       EN_toCore_instResp_enq ?
		 respQ_enqReq_lat_0$wget[16] :
		 respQ_enqReq_rl[16],
	       EN_toCore_instResp_enq ?
		 respQ_enqReq_lat_0$wget[15:0] :
		 respQ_enqReq_rl[15:0] } ;
  ...
  assign IF_respQ_enqReq_lat_1_whas__7_THEN_respQ_enqRe_ETC___d96 =
	     EN_toCore_instResp_enq ?
	       respQ_enqReq_lat_0$wget[68] :
	       respQ_enqReq_rl[68] ;
  assign NOT_pendQ_enqReq_dummy2_2_read__94_09_OR_IF_pe_ETC___d419 =
	     (!pendQ_enqReq_dummy2_2$Q_OUT ||
	      !EN_bootRomReq && !pendQ_enqReq_rl) &&
	     (pendQ_deqReq_dummy2_2$Q_OUT &&
	      (EN_bootRomResp || pendQ_deqReq_rl) ||
	      pendQ_empty) ;
  assign NOT_reqQ_clearReq_dummy2_1_read__3_4_OR_IF_req_ETC___d58 =
	     !reqQ_clearReq_dummy2_1$Q_OUT || !reqQ_clearReq_rl ;
  assign NOT_reqQ_enqReq_dummy2_2_read__9_4_OR_IF_reqQ__ETC___d79 =
	     (!reqQ_enqReq_dummy2_2$Q_OUT ||
	      (EN_bootRomReq ?
	     ...
	     (reqQ_deqReq_dummy2_2$Q_OUT &&
	      ...
	      reqQ_empty) ;
  assign NOT_respQ_clearReq_dummy2_1_read__12_13_OR_IF__ETC___d317 =
	     !respQ_clearReq_dummy2_1$Q_OUT || !respQ_clearReq_rl ;
  assign NOT_respQ_enqReq_dummy2_2_read__18_33_OR_IF_re_ETC___d338 =
	     (!respQ_enqReq_dummy2_2$Q_OUT ||
	      (EN_toCore_instResp_enq ?
		 !respQ_enqReq_lat_0$wget[68] :
		 !respQ_enqReq_rl[68])) &&
	     (respQ_deqReq_dummy2_2$Q_OUT &&
	      ...
	      respQ_empty) ;
  assign pendQ_enqReq_dummy2_2_read__94_AND_IF_pendQ_en_ETC___d406 =
	     pendQ_enqReq_dummy2_2$Q_OUT &&
	     (EN_bootRomReq || pendQ_enqReq_rl) ||
	     (!pendQ_deqReq_dummy2_2$Q_OUT ||
	      !EN_bootRomResp && !pendQ_deqReq_rl) &&
	     pendQ_full ;
  assign reqQ_enqReq_dummy2_2_read__9_AND_IF_reqQ_enqRe_ETC___d71 =
	     reqQ_enqReq_dummy2_2$Q_OUT &&
	     IF_reqQ_enqReq_lat_1_whas_THEN_reqQ_enqReq_lat_ETC___d13 ||
	     (!reqQ_deqReq_dummy2_2$Q_OUT ||
	      !EN_toCore_instReq_deq && !reqQ_deqReq_rl) &&
	     reqQ_full ;
  assign respQ_enqReq_dummy2_2_read__18_AND_IF_respQ_en_ETC___d330 =
	     respQ_enqReq_dummy2_2$Q_OUT &&
	     IF_respQ_enqReq_lat_1_whas__7_THEN_respQ_enqRe_ETC___d96 ||
	     (!respQ_deqReq_dummy2_2$Q_OUT ||
	      !EN_bootRomResp && !respQ_deqReq_rl) &&
