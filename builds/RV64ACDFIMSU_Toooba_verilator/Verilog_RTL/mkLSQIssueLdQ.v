...
//
// On Sun Mar 13 10:53:36 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkLSQIssueLdQ(CLK,
  ...
  reg [11 : 0] CASE_p478_0_sb2168_1_sb2325_DONTCARE__q11;
  ...
  assign first =
	     { CASE_p478_0_m_m_row_0_BITS_76_TO_72_1_m_m_row__ETC__q10,
	       ...
	       CASE_p478_0_sb2168_1_sb2325_DONTCARE__q11 } ;
  ...
  assign sb__h13088 =
	     m_m_specBits_1_dummy2_1$Q_OUT ?
	       IF_m_m_specBits_1_lat_0_whas__4_THEN_m_m_specB_ETC___d27 :
	       12'd0 ;
  assign upd__h3343 = sb__h12682 & specUpdate_correctSpeculation_mask ;
  assign upd__h4265 = sb__h13088 & specUpdate_correctSpeculation_mask ;
  assign upd__h5373 =
	     !m_m_deqP_ehr_dummy2_0$Q_OUT || !m_m_deqP_ehr_dummy2_1$Q_OUT ||
	     !m_m_deqP_ehr_rl ;
  ...
  always@(p__h6478 or sb__h12168 or sb__h12325)
  begin
    case (p__h6478)
      1'd0: CASE_p478_0_sb2168_1_sb2325_DONTCARE__q11 = sb__h12168;
      1'd1: CASE_p478_0_sb2168_1_sb2325_DONTCARE__q11 = sb__h12325;
    endcase
  end
