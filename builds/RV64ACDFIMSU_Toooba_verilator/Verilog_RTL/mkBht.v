...
//
// On Sun Mar 13 11:04:14 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkBht(CLK,
  ...
  wire [1 : 0] next_hist__h458, next_hist__h464;
  ...
  assign hist$D_IN = update_taken ? next_hist__h458 : next_hist__h464 ;
  assign hist$WE = EN_update ;

  // remaining internal signals
  assign next_hist__h458 =
	     (hist$D_OUT_3 == 2'b11) ? hist$D_OUT_3 : hist$D_OUT_3 + 2'd1 ;
  assign next_hist__h464 =
