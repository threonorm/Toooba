...
//
// On Sun Mar 13 11:05:10 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkGSharePred(CLK,
  ...
  wire [7 : 0] gHist__h4872, gHist__h5400;
  ...
  // submodule tab
  assign tab$ADDR_1 = gHist__h5400 ^ pred_1_pred_pc[9:2] ;
  assign tab$ADDR_2 = gHist__h4872 ^ pred_0_pred_pc[9:2] ;
  ...
  assign IF_predCnt_lat_0_whas_THEN_predCnt_lat_0_wget__ETC___d8 =
	     EN_pred_0_pred ? upd__h5527 : predCnt_rl ;
  assign IF_predRes_lat_0_whas__5_THEN_predRes_lat_0_wg_ETC___d18 =
	     EN_pred_0_pred ? upd__h5980 : predRes_rl ;
  assign gHist__h4872 = globalHist$history >> n__read__h4895 ;
  assign gHist__h5400 = globalHist$history >> n__read__h5423 ;
  assign n__read__h4895 =
	     (predCnt_dummy2_0$Q_OUT && predCnt_dummy2_1$Q_OUT &&
	      predCnt_dummy2_2$Q_OUT) ?
	       predCnt_rl :
	       2'd0 ;
  assign n__read__h5423 =
  ...
  assign res__h5758 =
	     (predRes_dummy2_1$Q_OUT && predRes_dummy2_2$Q_OUT) ?
	       ...
	       2'd0 ;
  assign upd__h3597 =
	     tab$D_OUT_1[1] ? res__h5758 | x__h5807 : res__h5758 & y__h6014 ;
  assign upd__h3847 = n__read__h5423 + 2'd1 ;
  assign upd__h5527 = n__read__h4895 + 2'd1 ;
  assign upd__h5980 =
	     tab$D_OUT_2[1] ? res__h5061 | x__h5110 : res__h5061 & y__h5318 ;
  assign x__h5110 = 2'd1 << n__read__h4895 ;
  assign x__h5807 = 2'd1 << n__read__h5423 ;
  assign y__h5318 = ~x__h5110 ;
  assign y__h6014 = ~x__h5807 ;
