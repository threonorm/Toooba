...
//
// On Sun Mar 13 11:08:53 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkSoC_Top(RST_N_dm_power_on_reset,
  ...
  begin
    ...
    v__h10652 = v__h10658 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_start_initial)
	$display("%0d: %m.rl_reset_start_initial ...", v__h10652);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h10873 = v__h10879 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete_initial)
	$display("%0d: %m.rl_reset_complete_initial", v__h10873);
  end
  // synopsys translate_on
endmodule  // mkSoC_Top
