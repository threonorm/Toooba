...
//
// On Sun Mar 13 11:05:13 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkTourPredSecure(CLK,
  ...
  reg [9 : 0] localHist__h10693, localHist__h12221;
  reg [2 : 0] cnt__h11384, cnt__h13077, localCnt__h5740;
  reg [1 : 0] choiceCnt__h7241,
	      cnt__h10963,
	      cnt__h11629,
	      cnt__h12660,
	      cnt__h13322,
  ...
  assign MUX_localBht$upd_2__VAL_2 =
	     updateEn$wget[3] ?
	       { n__h5899, localBht$D_OUT_1[2:0] } :
	       { localBht$D_OUT_1[5:3], n__h5899 } ;
  assign MUX_localHistTab$upd_2__VAL_1 =
	     updateEn$wget[28] ?
	       { n__h5567, localHistTab$D_OUT_3[9:0] } :
	       { localHistTab$D_OUT_3[19:10], n__h5567 } ;

  // inlined wires
  assign predCnt_lat_0$wget = n__read__h10729 + 2'd1 ;
  assign predCnt_lat_1$wget = n__read__h12257 + 2'd1 ;
  assign predRes_lat_0$wget =
	     IF_SEL_ARR_choiceBht_sub_gHistReg_history__43__ETC___d186 ?
	       res__h10895 | x__h10944 :
	       res__h10895 & y__h12132 ;
  assign predRes_lat_1$wget =
	     IF_SEL_ARR_choiceBht_sub_gHistReg_history__43__ETC___d243 ?
	       res__h12592 | x__h12641 :
	       res__h12592 & y__h13829 ;
  ...
  // submodule choiceBht
  assign choiceBht$ADDR_1 = globalHist__h12227[11:3] ;
  assign choiceBht$ADDR_2 = globalHist__h10699[11:3] ;
  ...
  // submodule globalBht
  assign globalBht$ADDR_1 = globalHist__h12227[11:3] ;
  assign globalBht$ADDR_2 = globalHist__h10699[11:3] ;
  ...
  assign localBht$ADDR_2 = localHist__h12221[9:1] ;
  assign localBht$ADDR_3 = localHist__h10693[9:1] ;
  ...
  assign globalHist__h10699 = gHistReg$history >> n__read__h10729 ;
  assign globalHist__h12227 = gHistReg$history >> n__read__h12257 ;
  assign n__h5567 = { updateEn$wget[25], updateEn$wget[12:4] } ;
  assign n__h5899 =
	     updateEn$wget[25] ?
	       ((localCnt__h5740 == 3'd7) ?
		  localCnt__h5740 :
		  localCnt__h5740 + 3'd1) :
	       ((localCnt__h5740 == 3'd0) ?
		  localCnt__h5740 :
		  localCnt__h5740 - 3'd1) ;
  assign n__h6496 =
	     updateEn$wget[25] ?
	       ((globalCnt__h6115 == 2'd3) ?
		  globalCnt__h6115 :
		  globalCnt__h6115 + 2'd1) :
	       ((globalCnt__h6115 == 2'd0) ?
		  globalCnt__h6115 :
		  globalCnt__h6115 - 2'd1) ;
  assign n__h7606 =
	     (updateEn$wget[1] == updateEn$wget[25]) ?
	       ((choiceCnt__h7241 == 2'd3) ?
		  choiceCnt__h7241 :
		  choiceCnt__h7241 + 2'd1) :
	       ((choiceCnt__h7241 == 2'd0) ?
		  choiceCnt__h7241 :
		  choiceCnt__h7241 - 2'd1) ;
  assign n__read__h10729 =
	     (predCnt_dummy2_0$Q_OUT && predCnt_dummy2_1$Q_OUT &&
	      predCnt_dummy2_2$Q_OUT) ?
	       predCnt_rl :
	       2'd0 ;
  assign n__read__h12257 =
  ...
  assign res__h12592 =
	     (predRes_dummy2_1$Q_OUT && predRes_dummy2_2$Q_OUT) ?
	       IF_predRes_lat_0_whas__5_THEN_predRes_lat_0_wg_ETC___d18 :
	       2'd0 ;
  assign upd__h12361 = predCnt_lat_0$wget ;
  assign upd__h13795 = predRes_lat_0$wget ;
  assign upd__h4165 = predRes_lat_1$wget ;
  assign upd__h4415 = predCnt_lat_1$wget ;
  assign x__h10944 = 2'd1 << n__read__h10729 ;
  assign x__h12641 = 2'd1 << n__read__h12257 ;
  assign y__h12132 = ~x__h10944 ;
  assign y__h13829 = ~x__h12641 ;
  always@(pred_0_pred_pc or localHistTab$D_OUT_2)
  begin
    case (pred_0_pred_pc[2])
      1'd0: localHist__h10693 = localHistTab$D_OUT_2[9:0];
      1'd1: localHist__h10693 = localHistTab$D_OUT_2[19:10];
    endcase
  end
  always@(pred_1_pred_pc or localHistTab$D_OUT_1)
  begin
    case (pred_1_pred_pc[2])
      1'd0: localHist__h12221 = localHistTab$D_OUT_1[9:0];
      1'd1: localHist__h12221 = localHistTab$D_OUT_1[19:10];
    endcase
  end
  always@(localHist__h10693 or localBht$D_OUT_3)
  begin
    case (localHist__h10693[0])
      1'd0: cnt__h11384 = localBht$D_OUT_3[2:0];
      1'd1: cnt__h11384 = localBht$D_OUT_3[5:3];
    endcase
  end
  always@(localHist__h12221 or localBht$D_OUT_2)
  begin
    case (localHist__h12221[0])
      1'd0: cnt__h13077 = localBht$D_OUT_2[2:0];
      1'd1: cnt__h13077 = localBht$D_OUT_2[5:3];
    endcase
  end
  always@(globalHist__h10699 or choiceBht$D_OUT_2)
  begin
    case (globalHist__h10699[7:0])
      8'd0: cnt__h10963 = choiceBht$D_OUT_2[1:0];
      8'd1: cnt__h10963 = choiceBht$D_OUT_2[3:2];
      8'd2: cnt__h10963 = choiceBht$D_OUT_2[5:4];
      8'd3: cnt__h10963 = choiceBht$D_OUT_2[7:6];
      8'd4: cnt__h10963 = choiceBht$D_OUT_2[9:8];
      8'd5: cnt__h10963 = choiceBht$D_OUT_2[11:10];
      8'd6: cnt__h10963 = choiceBht$D_OUT_2[13:12];
      8'd7: cnt__h10963 = choiceBht$D_OUT_2[15:14];
      default: cnt__h10963 = 2'b10 /* unspecified value */ ;
    endcase
  end
  always@(globalHist__h10699 or globalBht$D_OUT_2)
  begin
    case (globalHist__h10699[7:0])
      8'd0: cnt__h11629 = globalBht$D_OUT_2[1:0];
      8'd1: cnt__h11629 = globalBht$D_OUT_2[3:2];
      8'd2: cnt__h11629 = globalBht$D_OUT_2[5:4];
      8'd3: cnt__h11629 = globalBht$D_OUT_2[7:6];
      8'd4: cnt__h11629 = globalBht$D_OUT_2[9:8];
      8'd5: cnt__h11629 = globalBht$D_OUT_2[11:10];
      8'd6: cnt__h11629 = globalBht$D_OUT_2[13:12];
      8'd7: cnt__h11629 = globalBht$D_OUT_2[15:14];
      default: cnt__h11629 = 2'b10 /* unspecified value */ ;
    endcase
  end
  always@(globalHist__h12227 or choiceBht$D_OUT_1)
  begin
    case (globalHist__h12227[7:0])
      8'd0: cnt__h12660 = choiceBht$D_OUT_1[1:0];
      8'd1: cnt__h12660 = choiceBht$D_OUT_1[3:2];
      8'd2: cnt__h12660 = choiceBht$D_OUT_1[5:4];
      8'd3: cnt__h12660 = choiceBht$D_OUT_1[7:6];
      8'd4: cnt__h12660 = choiceBht$D_OUT_1[9:8];
      8'd5: cnt__h12660 = choiceBht$D_OUT_1[11:10];
      8'd6: cnt__h12660 = choiceBht$D_OUT_1[13:12];
      8'd7: cnt__h12660 = choiceBht$D_OUT_1[15:14];
      default: cnt__h12660 = 2'b10 /* unspecified value */ ;
    endcase
  end
  always@(globalHist__h12227 or globalBht$D_OUT_1)
  begin
    case (globalHist__h12227[7:0])
      8'd0: cnt__h13322 = globalBht$D_OUT_1[1:0];
      8'd1: cnt__h13322 = globalBht$D_OUT_1[3:2];
      8'd2: cnt__h13322 = globalBht$D_OUT_1[5:4];
      8'd3: cnt__h13322 = globalBht$D_OUT_1[7:6];
      8'd4: cnt__h13322 = globalBht$D_OUT_1[9:8];
      8'd5: cnt__h13322 = globalBht$D_OUT_1[11:10];
      8'd6: cnt__h13322 = globalBht$D_OUT_1[13:12];
      8'd7: cnt__h13322 = globalBht$D_OUT_1[15:14];
      default: cnt__h13322 = 2'b10 /* unspecified value */ ;
    endcase
  end
  always@(updateEn$wget or localBht$D_OUT_1)
  begin
    case (updateEn$wget[3])
      1'd0: localCnt__h5740 = localBht$D_OUT_1[2:0];
      1'd1: localCnt__h5740 = localBht$D_OUT_1[5:3];
    endcase
  end
  always@(updateEn$wget or globalBht$D_OUT_3)
  begin
    case (updateEn$wget[20:13])
      8'd0: globalCnt__h6115 = globalBht$D_OUT_3[1:0];
      8'd1: globalCnt__h6115 = globalBht$D_OUT_3[3:2];
      8'd2: globalCnt__h6115 = globalBht$D_OUT_3[5:4];
      8'd3: globalCnt__h6115 = globalBht$D_OUT_3[7:6];
      8'd4: globalCnt__h6115 = globalBht$D_OUT_3[9:8];
      8'd5: globalCnt__h6115 = globalBht$D_OUT_3[11:10];
      8'd6: globalCnt__h6115 = globalBht$D_OUT_3[13:12];
      8'd7: globalCnt__h6115 = globalBht$D_OUT_3[15:14];
      default: globalCnt__h6115 = 2'b10 /* unspecified value */ ;
    endcase
  end
  always@(updateEn$wget or choiceBht$D_OUT_3)
  begin
    case (updateEn$wget[20:13])
      8'd0: choiceCnt__h7241 = choiceBht$D_OUT_3[1:0];
      8'd1: choiceCnt__h7241 = choiceBht$D_OUT_3[3:2];
      8'd2: choiceCnt__h7241 = choiceBht$D_OUT_3[5:4];
      8'd3: choiceCnt__h7241 = choiceBht$D_OUT_3[7:6];
      8'd4: choiceCnt__h7241 = choiceBht$D_OUT_3[9:8];
      8'd5: choiceCnt__h7241 = choiceBht$D_OUT_3[11:10];
      8'd6: choiceCnt__h7241 = choiceBht$D_OUT_3[13:12];
      8'd7: choiceCnt__h7241 = choiceBht$D_OUT_3[15:14];
      default: choiceCnt__h7241 = 2'b10 /* unspecified value */ ;
    endcase
  end
