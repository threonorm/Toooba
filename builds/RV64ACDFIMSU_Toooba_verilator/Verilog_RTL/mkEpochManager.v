...
//
// On Sun Mar 13 10:47:32 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkEpochManager(CLK,
  ...
  wire [3 : 0] _theResult____h5024, checkedEpoch__h5070, next_epoch__h81;
  wire IF_NOT_updatePrevEn_1_dummy2_1_read__3_4_OR_IF_ETC___d58,
       IF_updatePrevEn_0_dummy2_1_read__6_AND_IF_upda_ETC___d82,
       IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d9,
       NOT_IF_updatePrevEn_0_dummy2_1_read__6_AND_IF__ETC___d84,
       NOT_prev_checked_epoch_9_ULE_updatePrevEpoch_0_ETC___d72,
       NOT_updatePrevEn_0_dummy2_1_read__6_9_OR_IF_up_ETC___d60,
       NOT_updatePrevEn_1_dummy2_1_read__3_4_OR_IF_up_ETC___d55,
       NOT_updatePrevEpoch_0_update_e_ULE_curr_epoch_7_3___d74,
       NOT_updatePrevEpoch_1_update_e_ULE_curr_epoch_7_5___d86,
       prev_checked_epoch_9_ULE_curr_epoch_7___d70;
  ...
  assign prev_checked_epoch$EN =
	     IF_NOT_updatePrevEn_1_dummy2_1_read__3_4_OR_IF_ETC___d58 ;
  ...
  // remaining internal signals
  assign IF_NOT_updatePrevEn_1_dummy2_1_read__3_4_OR_IF_ETC___d58 =
	     NOT_updatePrevEn_1_dummy2_1_read__3_4_OR_IF_up_ETC___d55 ?
	       updatePrevEn_0_dummy2_1$Q_OUT &&
	       IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d9 :
	       (EN_updatePrevEpoch_1_update ?
		  ...
		  updatePrevEn_1_rl[4]) ;
  assign IF_updatePrevEn_0_dummy2_1_read__6_AND_IF_upda_ETC___d82 =
	     _theResult____h5024 <= curr_epoch ;
  assign IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d9 =
	     EN_updatePrevEpoch_0_update ?
	       updatePrevEn_0_lat_0$wget[4] :
	       updatePrevEn_0_rl[4] ;
  assign NOT_IF_updatePrevEn_0_dummy2_1_read__6_AND_IF__ETC___d84 =
	     _theResult____h5024 > updatePrevEpoch_1_update_e ;
  assign NOT_prev_checked_epoch_9_ULE_updatePrevEpoch_0_ETC___d72 =
	     prev_checked_epoch > updatePrevEpoch_0_update_e ;
  assign NOT_updatePrevEn_0_dummy2_1_read__6_9_OR_IF_up_ETC___d60 =
	     !updatePrevEn_0_dummy2_1$Q_OUT ||
	     (EN_updatePrevEpoch_0_update ?
		!updatePrevEn_0_lat_0$wget[4] :
		!updatePrevEn_0_rl[4]) ;
  assign NOT_updatePrevEn_1_dummy2_1_read__3_4_OR_IF_up_ETC___d55 =
	     !updatePrevEn_1_dummy2_1$Q_OUT ||
	     (EN_updatePrevEpoch_1_update ?
		!updatePrevEn_1_lat_0$wget[4] :
		!updatePrevEn_1_rl[4]) ;
  assign NOT_updatePrevEpoch_0_update_e_ULE_curr_epoch_7_3___d74 =
	     updatePrevEpoch_0_update_e > curr_epoch ;
  assign NOT_updatePrevEpoch_1_update_e_ULE_curr_epoch_7_5___d86 =
	     updatePrevEpoch_1_update_e > curr_epoch ;
  assign _theResult____h5024 =
	     (updatePrevEn_0_dummy2_1$Q_OUT &&
	      IF_updatePrevEn_0_lat_0_whas_THEN_updatePrevEn_ETC___d9) ?
	       checkedEpoch__h5070 :
	       prev_checked_epoch ;
  assign checkedEpoch__h5070 =
	     EN_updatePrevEpoch_0_update ?
	       updatePrevEn_0_lat_0$wget[3:0] :
	       updatePrevEn_0_rl[3:0] ;
  assign next_epoch__h81 = (curr_epoch == 4'd11) ? 4'd0 : curr_epoch + 4'd1 ;
  assign prev_checked_epoch_9_ULE_curr_epoch_7___d70 =
  ...
  begin
	...
	$finish(32'd0);
    if (RST_N != `BSV_RESET_VALUE)
      if (IF_NOT_updatePrevEn_1_dummy2_1_read__3_4_OR_IF_ETC___d58 &&
	  NOT_updatePrevEn_1_dummy2_1_read__3_4_OR_IF_up_ETC___d55 &&
	  NOT_updatePrevEn_0_dummy2_1_read__6_9_OR_IF_up_ETC___d60)
	$fdisplay(32'h80000002, "\n%m: ASSERT FAIL!!");
    if (RST_N != `BSV_RESET_VALUE)
