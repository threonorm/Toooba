...
module mkFpuMulDivRegToExeFifo(CLK,
  ...
  wire [11 : 0] IF_m_m_specBits_0_dummy2_0_read__6_AND_m_m_spe_ETC___d79,
  ...
  assign first =
	     { m_m_row_0,
	       IF_m_m_specBits_0_dummy2_0_read__6_AND_m_m_spe_ETC___d79 } ;
  ...
  assign MUX_m_m_valid_0_dummy2_0$write_1__SEL_1 =
	     EN_specUpdate_incorrectSpeculation &&
	     (specUpdate_incorrectSpeculation_kill_all ||
	      IF_m_m_specBits_0_dummy2_0_read__6_AND_m_m_spe_ETC___d79[specUpdate_incorrectSpeculation_kill_tag]) ;

  // inlined wires
  assign m_m_valid_0_lat_0$whas =
	     MUX_m_m_valid_0_dummy2_0$write_1__SEL_1 || EN_deq ;
  assign m_m_specBits_0_lat_1$wget =
	     sb__h9487 & specUpdate_correctSpeculation_mask ;
  ...
  // remaining internal signals
  assign IF_m_m_specBits_0_dummy2_0_read__6_AND_m_m_spe_ETC___d79 =
	     (m_m_specBits_0_dummy2_0$Q_OUT &&
	      m_m_specBits_0_dummy2_1$Q_OUT) ?
	       m_m_specBits_0_rl :
	       12'd0 ;
