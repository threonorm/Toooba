...
//
// On Sun Mar 13 10:49:15 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkRobRowSynth(CLK,
  ...
  wire [161 : 0] IF_m_tval_dummy2_0_read__59_AND_m_tval_dummy2__ETC___d422;
  wire [65 : 0] write_enq_x_BITS_97_TO_32__q2;
  wire [63 : 0] IF_IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_m_ETC___d187,
		IF_m_ppc_vaddr_csrData_dummy2_0_read__75_AND_m_ETC___d290,
		IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_IF__ETC___d156,
		IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d158,
		IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d171,
		IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d184,
		x__h25418;
  wire [11 : 0] IF_m_spec_bits_lat_1_whas__67_THEN_m_spec_bits_ETC___d273,
		bs__h31080,
		sb__h31115,
		upd__h17601;
  wire [5 : 0] write_enq_x_BITS_167_TO_162__q1;
  wire [4 : 0] IF_m_trap_lat_2_whas_THEN_IF_m_trap_lat_2_wget_ETC___d79,
	       x_read_deq_fflags__h24926;
  wire [3 : 0] IF_IF_m_trap_lat_2_whas_THEN_m_trap_lat_2_wget_ETC___d78;
  wire [1 : 0] IF_m_ldKilled_lat_1_whas__15_THEN_IF_m_ldKille_ETC___d237,
	       IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_IF__ETC___d138,
	       IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d140;
  wire IF_m_ldKilled_lat_1_whas__15_THEN_m_ldKilled_l_ETC___d224,
       IF_m_memAccessAtCommit_lat_1_whas__43_THEN_m_m_ETC___d249,
       IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_m_p_ETC___d142,
       IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_m_p_ETC___d160,
       IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_m_pp_ETC___d144,
       IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_m_pp_ETC___d162,
       IF_m_rob_inst_state_lat_3_whas__00_THEN_m_rob__ETC___d212,
       NOT_m_csr_38_BIT_12_39_EQ_setExecuted_doFinish_ETC___d440,
       NOT_m_csr_38_BIT_12_39_EQ_setExecuted_doFinish_ETC___d448,
       NOT_m_ppc_vaddr_csrData_dummy2_0_read__75_76_O_ETC___d285,
       m_ppc_vaddr_csrData_dummy2_0_read__75_AND_m_pp_ETC___d289,
       m_rob_inst_state_dummy2_0_read__74_AND_m_rob_i_ETC___d385,
       m_trap_dummy2_0_read__44_AND_m_trap_dummy2_1_r_ETC___d349;
  ...
  assign read_deq =
	     { m_pc,
	       ...
	       m_trap_dummy2_0_read__44_AND_m_trap_dummy2_1_r_ETC___d349,
	       m_trap_rl[4:0],
	       IF_m_tval_dummy2_0_read__59_AND_m_tval_dummy2__ETC___d422 } ;
  ...
  // value method dependsOn_wrongSpec
  assign dependsOn_wrongSpec = bs__h31080[dependsOn_wrongSpec_tag] ;
  ...
  assign m_ldKilled_rl$D_IN =
	     { IF_m_ldKilled_lat_1_whas__15_THEN_m_ldKilled_l_ETC___d224,
	       IF_m_ldKilled_lat_1_whas__15_THEN_IF_m_ldKille_ETC___d237 } ;
  ...
  assign m_ppc_vaddr_csrData_rl$D_IN =
	     { IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d140,
	       IF_IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_m_ETC___d187 } ;
  ...
  assign m_spec_bits_rl$D_IN =
	     EN_correctSpeculation ?
	       upd__h17601 :
	       IF_m_spec_bits_lat_1_whas__67_THEN_m_spec_bits_ETC___d273 ;
  ...
  assign m_trap_rl$D_IN =
		 ...
		 (m_trap_lat_0$whas ? m_trap_lat_0$wget[5] : m_trap_rl[5]),
	       IF_m_trap_lat_2_whas_THEN_IF_m_trap_lat_2_wget_ETC___d79 } ;
  ...
  // remaining internal signals
  assign IF_IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_m_ETC___d187 =
	     IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_m_pp_ETC___d144 ?
	       IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d158 :
	       (IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_m_pp_ETC___d162 ?
		  IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d171 :
		  IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d184) ;
  assign IF_IF_m_trap_lat_2_whas_THEN_m_trap_lat_2_wget_ETC___d78 =
	     (EN_write_enq ?
		write_enq_x_BITS_167_TO_162__q1[5] &&
		!write_enq_x_BITS_167_TO_162__q1[4] :
		(m_trap_lat_0$whas ?
		   m_trap_lat_0$wget[5] && !m_trap_lat_0$wget[4] :
		   m_trap_rl[5] && !m_trap_rl[4])) ?
	       (EN_write_enq ?
		  ...
		  (m_trap_lat_0$whas ?
		     m_trap_lat_0$wget[3:0] :
		     m_trap_rl[3:0])) ;
  assign IF_m_ldKilled_lat_1_whas__15_THEN_IF_m_ldKille_ETC___d237 =
	     EN_write_enq ?
	       2'b10 :
	       (EN_setExecuted_deqLSQ ?
		  setExecuted_deqLSQ_ld_killed[1:0] :
		  m_ldKilled_rl[1:0]) ;
  assign IF_m_ldKilled_lat_1_whas__15_THEN_m_ldKilled_l_ETC___d224 =
	     !EN_write_enq &&
	     (EN_setExecuted_deqLSQ ?
		setExecuted_deqLSQ_ld_killed[2] :
		m_ldKilled_rl[2]) ;
  assign IF_m_memAccessAtCommit_lat_1_whas__43_THEN_m_m_ETC___d249 =
	     EN_write_enq ?
	       write_enq_x[257:253] == 5'd14 :
	       (EN_setExecuted_doFinishMem ?
		  setExecuted_doFinishMem_access_at_commit :
		  m_memAccessAtCommit_rl) ;
  assign IF_m_ppc_vaddr_csrData_dummy2_0_read__75_AND_m_ETC___d290 =
	     m_ppc_vaddr_csrData_dummy2_0_read__75_AND_m_pp_ETC___d289 ?
	       m_ppc_vaddr_csrData_rl[63:0] :
	       64'd0 ;
  assign IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_IF__ETC___d138 =
	     EN_setExecuted_doFinishAlu_1_set ?
	       m_ppc_vaddr_csrData_lat_1$wget[65:64] :
	       (EN_setExecuted_doFinishAlu_0_set ?
		  m_ppc_vaddr_csrData_lat_0$wget[65:64] :
		  m_ppc_vaddr_csrData_rl[65:64]) ;
  assign IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_IF__ETC___d156 =
	     EN_setExecuted_doFinishAlu_1_set ?
	       m_ppc_vaddr_csrData_lat_1$wget[63:0] :
	       (EN_setExecuted_doFinishAlu_0_set ?
		  m_ppc_vaddr_csrData_lat_0$wget[63:0] :
		  m_ppc_vaddr_csrData_rl[63:0]) ;
  assign IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_m_p_ETC___d142 =
	     EN_setExecuted_doFinishAlu_1_set ?
	       m_ppc_vaddr_csrData_lat_1$wget[65:64] == 2'd0 :
	       (EN_setExecuted_doFinishAlu_0_set ?
		  m_ppc_vaddr_csrData_lat_0$wget[65:64] == 2'd0 :
		  m_ppc_vaddr_csrData_rl[65:64] == 2'd0) ;
  assign IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_m_p_ETC___d160 =
	     EN_setExecuted_doFinishAlu_1_set ?
	       m_ppc_vaddr_csrData_lat_1$wget[65:64] == 2'd1 :
	       (EN_setExecuted_doFinishAlu_0_set ?
		  m_ppc_vaddr_csrData_lat_0$wget[65:64] == 2'd1 :
		  m_ppc_vaddr_csrData_rl[65:64] == 2'd1) ;
  assign IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d140 =
	     EN_write_enq ?
	       write_enq_x_BITS_97_TO_32__q2[65:64] :
	       (EN_setExecuted_doFinishMem ?
		  m_ppc_vaddr_csrData_lat_2$wget[65:64] :
		  IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_IF__ETC___d138) ;
  assign IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d158 =
	     EN_write_enq ?
	       write_enq_x_BITS_97_TO_32__q2[63:0] :
	       (EN_setExecuted_doFinishMem ?
		  m_ppc_vaddr_csrData_lat_2$wget[63:0] :
		  IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_IF__ETC___d156) ;
  assign IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d171 =
	     EN_write_enq ?
	       write_enq_x_BITS_97_TO_32__q2[63:0] :
	       (EN_setExecuted_doFinishMem ?
		  m_ppc_vaddr_csrData_lat_2$wget[63:0] :
		  IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_IF__ETC___d156) ;
  assign IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_IF_m_ETC___d184 =
	     EN_write_enq ?
	       write_enq_x_BITS_97_TO_32__q2[63:0] :
	       (EN_setExecuted_doFinishMem ?
		  m_ppc_vaddr_csrData_lat_2$wget[63:0] :
		  IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_IF__ETC___d156) ;
  assign IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_m_pp_ETC___d144 =
	     EN_write_enq ?
	       write_enq_x_BITS_97_TO_32__q2[65:64] == 2'd0 :
	       (EN_setExecuted_doFinishMem ?
		  m_ppc_vaddr_csrData_lat_2$wget[65:64] == 2'd0 :
		  IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_m_p_ETC___d142) ;
  assign IF_m_ppc_vaddr_csrData_lat_3_whas__3_THEN_m_pp_ETC___d162 =
	     EN_write_enq ?
	       write_enq_x_BITS_97_TO_32__q2[65:64] == 2'd1 :
	       (EN_setExecuted_doFinishMem ?
		  m_ppc_vaddr_csrData_lat_2$wget[65:64] == 2'd1 :
		  IF_m_ppc_vaddr_csrData_lat_1_whas__11_THEN_m_p_ETC___d160) ;
  assign IF_m_rob_inst_state_lat_3_whas__00_THEN_m_rob__ETC___d212 =
	     EN_setExecuted_deqLSQ ||
	     EN_setExecuted_doFinishFpuMulDiv_0_set ||
	     EN_setExecuted_doFinishAlu_1_set ||
	     EN_setExecuted_doFinishAlu_0_set ||
	     m_rob_inst_state_rl ;
  assign IF_m_spec_bits_lat_1_whas__67_THEN_m_spec_bits_ETC___d273 =
	     EN_write_enq ? write_enq_x[11:0] : m_spec_bits_rl ;
  assign IF_m_trap_lat_2_whas_THEN_IF_m_trap_lat_2_wget_ETC___d79 =
	     { EN_write_enq ?
		 write_enq_x_BITS_167_TO_162__q1[4] :
		 (m_trap_lat_0$whas ? m_trap_lat_0$wget[4] : m_trap_rl[4]),
	       IF_IF_m_trap_lat_2_whas_THEN_m_trap_lat_2_wget_ETC___d78 } ;
  assign IF_m_tval_dummy2_0_read__59_AND_m_tval_dummy2__ETC___d422 =
	     { x__h25418,
	       m_ppc_vaddr_csrData_dummy2_0_read__75_AND_m_pp_ETC___d289 ?
		 m_ppc_vaddr_csrData_rl[65:64] :
		 2'd0,
		...
		m_ppc_vaddr_csrData_rl[65:64] == 2'd0) ?
		 ...
		 m_ppc_vaddr_csrData_rl[63:0],
	       ...
	       m_epochIncremented,
	       bs__h31080 } ;
  assign NOT_m_csr_38_BIT_12_39_EQ_setExecuted_doFinish_ETC___d440 =
	     m_csr[12] != setExecuted_doFinishAlu_0_set_csrData[64] ;
  assign NOT_m_csr_38_BIT_12_39_EQ_setExecuted_doFinish_ETC___d448 =
	     m_csr[12] != setExecuted_doFinishAlu_1_set_csrData[64] ;
  assign NOT_m_ppc_vaddr_csrData_dummy2_0_read__75_76_O_ETC___d285 =
	     !m_ppc_vaddr_csrData_dummy2_0$Q_OUT ||
	     !m_ppc_vaddr_csrData_dummy2_1$Q_OUT ||
	     !m_ppc_vaddr_csrData_dummy2_2$Q_OUT ||
	     !m_ppc_vaddr_csrData_dummy2_3$Q_OUT ;
  assign bs__h31080 =
	     (m_spec_bits_dummy2_0$Q_OUT && m_spec_bits_dummy2_1$Q_OUT &&
	      m_spec_bits_dummy2_2$Q_OUT) ?
	       m_spec_bits_rl :
	       12'd0 ;
  assign m_ppc_vaddr_csrData_dummy2_0_read__75_AND_m_pp_ETC___d289 =
	     m_ppc_vaddr_csrData_dummy2_0$Q_OUT &&
	     m_ppc_vaddr_csrData_dummy2_1$Q_OUT &&
	     m_ppc_vaddr_csrData_dummy2_2$Q_OUT &&
	     m_ppc_vaddr_csrData_dummy2_3$Q_OUT ;
  assign m_rob_inst_state_dummy2_0_read__74_AND_m_rob_i_ETC___d385 =
	     m_rob_inst_state_dummy2_0$Q_OUT &&
	     m_rob_inst_state_dummy2_1$Q_OUT &&
	     m_rob_inst_state_dummy2_2$Q_OUT &&
	     m_rob_inst_state_dummy2_3$Q_OUT &&
	     ...
	     m_rob_inst_state_dummy2_5$Q_OUT &&
	     m_rob_inst_state_rl ;
  assign m_trap_dummy2_0_read__44_AND_m_trap_dummy2_1_r_ETC___d349 =
  ...
  assign sb__h31115 =
	     m_spec_bits_dummy2_2$Q_OUT ?
	       IF_m_spec_bits_lat_1_whas__67_THEN_m_spec_bits_ETC___d273 :
	       12'd0 ;
  assign upd__h17601 = sb__h31115 & correctSpeculation_mask ;
  ...
  assign x__h25418 =
	     (m_tval_dummy2_0$Q_OUT && m_tval_dummy2_1$Q_OUT &&
	      m_tval_dummy2_2$Q_OUT) ?
	       m_tval_rl :
	       64'd0 ;
  assign x_read_deq_fflags__h24926 =
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_setExecuted_doFinishAlu_0_set &&
	  NOT_m_csr_38_BIT_12_39_EQ_setExecuted_doFinish_ETC___d440)
	$display("Dynamic assertion failed: \"../../src_Core/RISCY_OOO/procs/lib/ReorderBuffer.bsv\", line 244, column 60\ncsr valid should match");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_setExecuted_doFinishAlu_0_set &&
	  NOT_m_csr_38_BIT_12_39_EQ_setExecuted_doFinish_ETC___d440)
	$finish(32'd0);
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_setExecuted_deqLSQ &&
	  m_trap_dummy2_0_read__44_AND_m_trap_dummy2_1_r_ETC___d349)
	$display("Dynamic assertion failed: \"../../src_Core/RISCY_OOO/procs/lib/ReorderBuffer.bsv\", line 387, column 52\ncannot have trap");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_setExecuted_deqLSQ &&
	  m_trap_dummy2_0_read__44_AND_m_trap_dummy2_1_r_ETC___d349)
	$finish(32'd0);
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  setExecuted_doFinishMem_access_at_commit &&
	  setExecuted_doFinishMem_non_mmio_st_done)
	$display("Dynamic assertion failed: \"../../src_Core/RISCY_OOO/procs/lib/ReorderBuffer.bsv\", line 274, column 18\ncannot both be true");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_setExecuted_doFinishMem &&
	  setExecuted_doFinishMem_access_at_commit &&
	  setExecuted_doFinishMem_non_mmio_st_done)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  setExecuted_doFinishMem_non_mmio_st_done &&
	  m_iType != 5'd5)
	$display("Dynamic assertion failed: \"../../src_Core/RISCY_OOO/procs/lib/ReorderBuffer.bsv\", line 278, column 35\nmust be St");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_setExecuted_doFinishMem &&
	  setExecuted_doFinishMem_non_mmio_st_done &&
	  m_iType != 5'd5)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write_enq && write_enq_x[18])
	$display("Dynamic assertion failed: \"../../src_Core/RISCY_OOO/procs/lib/ReorderBuffer.bsv\", line 341, column 40\nld killed must be false");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write_enq && write_enq_x[15])
	$display("Dynamic assertion failed: \"../../src_Core/RISCY_OOO/procs/lib/ReorderBuffer.bsv\", line 342, column 48\nmem access at commit must be false");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write_enq && write_enq_x[14])
	$display("Dynamic assertion failed: \"../../src_Core/RISCY_OOO/procs/lib/ReorderBuffer.bsv\", line 343, column 42\nlsq notified must be false");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write_enq && write_enq_x[13])
	$display("Dynamic assertion failed: \"../../src_Core/RISCY_OOO/procs/lib/ReorderBuffer.bsv\", line 344, column 36\nnon mmio st must be false");
    if (RST_N != `BSV_RESET_VALUE)
