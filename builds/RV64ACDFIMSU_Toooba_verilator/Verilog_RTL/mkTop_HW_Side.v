...
//
// On Sun Mar 13 11:08:58 CET 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkTop_HW_Side(CLK,
  ...
  reg [63 : 0] y_avValue_fst__h608;
  reg [63 : 0] y_avValue_snd__h609;
  reg [7 : 0] v__h790;
  reg [63 : 0] tohost_addr__h617;
  reg [63 : 0] fromhost_addr__h618;
  ...
  // submodule soc_top
  assign soc_top$put_from_console_put = v__h790 ;
  ...
  assign soc_top$start_fromhost_addr = fromhost_addr__h618 ;
  assign soc_top$start_tohost_addr = tohost_addr__h617 ;
  ...
  begin
	...
	begin
	  y_avValue_fst__h608 = $imported_c_get_symbol_val("tohost");
	  #0;
	end
    tohost_addr__h617 = TASK_testplusargs___d17 ? y_avValue_fst__h608 : 64'd0;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_step0 && TASK_testplusargs___d17)
	begin
	  y_avValue_snd__h609 = $imported_c_get_symbol_val("fromhost");
	  #0;
	end
    fromhost_addr__h618 =
	TASK_testplusargs___d17 ? y_avValue_snd__h609 : 64'd0;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_step0)
	...
	begin
	  v__h790 = $imported_c_trygetchar(8'hAA);
	  #0;
	end
  end
  // synopsys translate_on
